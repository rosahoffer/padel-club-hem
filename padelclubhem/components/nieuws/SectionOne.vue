...
<template>
    <div class="wrapper">
        <section class="intro-content">
            <p class="subtitle-medium">Nieuws</p>
            <h1>De Padel praat</h1>
            <p>Blijf op de hoogte van alles wat er speelt in onze bruisende padelcommunity! Of je nu een doorgewinterde
                speler bent of net begint met deze spannende sport, hier vind je al het laatste nieuws, aankomende
                evenementen, en belangrijke aankondigingen van onze club. Van toernooiverslagen en trainingsschema’s tot
                gezellige clubactiviteiten en belangrijke mededelingen, we zorgen ervoor dat je niets mist.</p>
        </section>
            ...
            <div class="image-wrapper">
                <div class="image-overlay">
                    <div class="image-container">
                        <img src="/assets/images/nieuws.png" alt="Afbeelding van de evenementen pagina" loading="lazy"
