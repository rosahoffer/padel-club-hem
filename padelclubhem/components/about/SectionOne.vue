...
<template>
    <div class="wrapper">
        <section class="intro-content">
            ...
            <h1>Ons Verhaal</h1>
            <p>Padelclub Hem heeft een rijke voorgeschiedenis. Al tientallen jaren wordt er op de Torenweg in Hem
                getennist. Sinds 2023 hebben we onze faciliteiten uitgebreid met twee padelbanen. De kantine, die ooit
                overuren draaide, herleeft weer in volle glorie.
            </p>
            <p>Deze heropleving is mogelijk gemaakt door een samenwerking tussen Dennis en Floris, de mannen achter de
                eerste padelbanen (Allesvoorpadel), en Jan & Arjan van de bloembollenhal. Dankzij deze samenwerking komt
                er een verdere uitbreiding van onze club.
            </p>
        </section>
            ...
            <div class="image-wrapper">
                <div class="image-overlay">
                    <div class="image-container">
                        <img src="/assets/images/eigenaren.png" alt="Afbeelding van de evenementen pagina" loading="lazy"
